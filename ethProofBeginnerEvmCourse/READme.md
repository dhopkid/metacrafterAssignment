...
My code is found in the file dhopeworld.sol

blockchain token named DOP
...
create a new file called dhopeworld.sol under the contracts folder in the remix ide explorer
